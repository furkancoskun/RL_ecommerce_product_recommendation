...
def evaluate_policy_cql(
    ...
    try:
        loaded_policy_config = DiscreteCQLConfig(gamma=gamma)
...
if __name__ == "__main__":
    ...
    POLICY_PATH = os.path.join(MODEL_SAVE_DIR, "cql_policy.pt")
    DATA_DIR = "data"
    ...
    average_actual_return, std_actual_return = evaluate_policy_cql(
        POLICY_PATH,
        train_episodes,
        test_episodes,
        GAMMA,
